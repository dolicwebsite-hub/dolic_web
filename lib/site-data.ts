...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Bơm 1.5kW 220V", englishName: "DOLIC Standard Water Pump (1.5 kW)", model: "QDX70-8-1.5", origin: "Trung Quốc - Yimin", specs: "1.5kW - 220V - 70m3/h - cửa xả 100mm - 19kg - IPX8", price: "4.200.000", image: "/assets/products/drive-full/qdx70-8-15-bom.webp", status: "Đang bán", details: `${pumpDetail} Cân nặng 19kg. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Tam hoa cơ 0.75kW 220V", englishName: "DOLIC Tam Hoa Mechanical Auto Feeder (0.75 kW, 220V)", model: "YL-0.75", origin: "Trung Quốc - Yimin", specs: "0.75kW - 220V - ≥1.1 kg O2/h - 42kg - 148 vòng/phút - IPX8", price: "6.000.000", image: "/assets/products/drive-full/tam-hoa-co-075.webp", status: "Đang bán", details: "Motor nam châm vĩnh cửu hiệu suất cao, khung inox 304, phao HDPE. Tuổi thọ động cơ ước tính 3-5 năm. Ưu điểm: hiệu suất cao, nhiệt độ làm việc thấp, lưu lượng nước lớn.", usp: inverterUsp, priority: "Đang bán" },
