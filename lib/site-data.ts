...
export const productCategories: ProductCategory[] = [
  {
    ...
    products: [
      { name: "Quạt 10 cánh 2.2kW 380V hộp số", englishName: "DOLIC 10-Blade Gear-Driven Paddle Wheel Aerator (2.2 kW, 380V)", model: "YC 2.2", origin: "Trung Quốc - Yimin", specs: "2.2kW - 380V - ≥3.4 kg O2/h - 76kg - 190 vòng/phút - IPX8", price: "12.900.000", image: "/assets/product-aerator.png", status: "Đang bán", details: `${aeratorPatentDetail} Tuổi thọ động cơ ước tính 5 năm.`, usp: aeratorUsp, priority: "Đang bán" },
      { name: "Quạt 6 cánh 1.5kW 380V hộp số", englishName: "DOLIC 6-Blade Gear-Driven Paddle Wheel Aerator (1.5 kW, 380V)", model: "YC 1.5Z", origin: "Trung Quốc - Yimin", specs: "1.5kW - 380V - ≥2.2 kg O2/h - 63.5kg - 190 vòng/phút - IPX8", price: "9.300.000", image: "/assets/products/aerator-6-canh-15kw-hop-so-b.png", status: "Đang bán", details: `${aeratorPatentDetail} Tuổi thọ động cơ ước tính 5 năm.`, usp: aeratorUsp, priority: "Đang bán" },
      { name: "Quạt 6 cánh 1.5kW 380V bánh răng", englishName: "DOLIC 6-Blade Gear Wheel Paddle Wheel Aerator (1.5 kW, 380V)", model: "YC 1.5", origin: "Trung Quốc - Yimin", specs: "1.5kW - 380V - ≥2.2 kg O2/h - 63.5kg - 190 vòng/phút - IPX8", price: "9.300.000", image: "/assets/products/aerator-4-canh-15kw-banh-rang-xanh-b.png", status: "Đang bán", details: `${aeratorPatentDetail} Tuổi thọ động cơ ước tính 5 năm.`, usp: aeratorUsp, priority: "Đang bán" },
      ...
      { name: "Quạt 4 cánh 1.1kW 220V bánh răng", englishName: "DOLIC 4-Blade Open-Gear Paddle Wheel Aerator (1.1 kW, 220V)", model: "YC 1.1", origin: "Trung Quốc - Yimin", specs: "1.1kW - 220V - ≥2.2 kg O2/h - 63.5kg - 190 vòng/phút - IPX8", price: "8.300.000", image: "/assets/products/aerator-4-canh-11kw-hop-so.jpg", status: "Đang bán", details: `${aeratorPatentDetail} Tuổi thọ động cơ ước tính 3-5 năm.`, usp: aeratorUsp, priority: "Đang bán" },
      { name: "Quạt 2 cánh 0.75kW 220V", englishName: "DOLIC 2-Blade Paddle Wheel Aerator (0.75 kW, 220V)", model: "YC 0.75DZ", origin: "Trung Quốc - Yimin", specs: "0.75kW - 220V - ≥0.9 kg O2/h - 34kg - 190 vòng/phút - IPX8", price: "5.900.000", image: "/assets/products/aerator-2-canh-075kw-220v.jpg", status: "Đang bán", details: `${aeratorPatentDetail} Tuổi thọ động cơ ước tính 3-5 năm.`, usp: aeratorUsp, priority: "Đang bán" },
      { name: "Quạt 2 cánh 0.75kW 380V", englishName: "DOLIC 2-Blade Paddle Wheel Aerator (0.75 kW, 380V)", model: "YC 0.75Z", origin: "Trung Quốc - Yimin", specs: "0.75kW - 380V - ≥0.9 kg O2/h - 34kg - 190 vòng/phút - IPX8", price: "5.900.000", image: "/assets/products/aerator-2-canh-075kw-220v.jpg", status: "Đang bán", details: `${aeratorPatentDetail} Tuổi thọ động cơ ước tính 3-5 năm.`, usp: aeratorUsp, priority: "Đang bán" },
      { name: "Quạt 4 cánh xanh to 1.5kW 380V bánh răng", englishName: "DOLIC 4-Blade Large Green Open-Gear Paddle Wheel Aerator (1.5 kW, 380V)", model: "SC 1.5", origin: "Trung Quốc - Yimin", specs: "1.5kW - 380V - ≥2.2 kg O2/h - 71kg - 107 vòng/phút - IPX8", price: "9.000.000", image: "/assets/products/aerator-4-canh-15kw-banh-rang-xanh-b.png", status: "Mới ra mắt", details: "Vỏ motor inox 304 xỉn, cánh quạt nhựa nylon, phao nhựa HDPE. Cánh quạt lớn giúp dòng chảy mạnh hơn; thiết kế răng lược tạo oxy, phần giữa cánh không có lỗ để tạo dòng chảy mạnh hơn. Tuổi thọ động cơ ước tính 3-5 năm.", usp: aeratorUsp, priority: "Mới ra mắt" },
    ],
  },
  {
    id: "thiet-bi-do-nuoc",
  ...
  },
  {
    ...
    products: [
      { name: "Bơm 11kW 380V", englishName: "DOLIC Water Pump (11 kW)", model: "QY250-9.5-11", origin: "Trung Quốc - Yimin", specs: "11kW - 380V - cửa xả 200mm - đẩy cao 9.5m - 73kg - IPX8", price: "18.000.000", image: "/assets/product-pump.png", status: "Đang bán", details: `${pumpDetail} Lưu lượng/cột áp: 20m3/16.3m, 30m3/10.9m, 35m3/7.2m. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
      { name: "Bơm 7.5kW có phao 380V", englishName: "DOLIC Float Switch Water Pump (7.5 kW)", model: "FB 200-7.5", origin: "Trung Quốc - Yimin", specs: "7.5kW - 380V - 380m3/h - cửa xả 200mm - đẩy cao 6m - IPX8", price: "12.000.000", image: "/assets/products/pump-75kw-380v.png", status: "Đang bán", details: `${pumpDetail} Cân nặng 58kg. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
      { name: "Bơm 4kW tiêu chuẩn 380V", englishName: "DOLIC Standard Water Pump (4 kW)", model: "QY200-4-4", origin: "Trung Quốc - Yimin", specs: "4kW - 380V - 200m3/h - cửa xả 152mm - đẩy cao 6m - IPX8", price: "6.900.000", image: "/assets/product-pump.png", status: "Đang bán", details: `${pumpDetail} Cân nặng 35kg. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
      { name: "Bơm 4kW biến tần 380V", englishName: "DOLIC VFD Water Pump (4 kW)", model: "QT200-4-4", origin: "Trung Quốc - Yimin", specs: "4kW - 380V - 200m3/h - cửa xả 152mm - đẩy cao 4m - IPX8", price: "9.300.000", image: "/assets/products/pump-4kw-380v-bien-tan.png", status: "Đang bán", details: `${pumpDetail} Cân nặng 20kg. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
      { name: "Bơm 1.5kW 220V", englishName: "DOLIC Standard Water Pump (1.5 kW)", model: "QDX70-8-1.5", origin: "Trung Quốc - Yimin", specs: "1.5kW - 220V - 70m3/h - cửa xả 100mm - 19kg - IPX8", price: "4.200.000", image: "/assets/products/pump-15kw-220v.jpg", status: "Đang bán", details: `${pumpDetail} Cân nặng 19kg. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
      { name: "Bơm 0.75kW 220V", englishName: "DOLIC Standard Water Pump (0.75 kW)", model: "FB-80-0.75D", origin: "Trung Quốc - Yimin", specs: "0.75kW - 220V - 50m3/h - cửa xả 80mm - đẩy cao 3m - IPX8", price: "2.600.000", image: "/assets/products/pump-075kw-220v.jpg", status: "Đang bán", details: `${pumpDetail} Cân nặng 15kg. Tuổi thọ động cơ ước tính 3-5 năm.`, usp: pumpUsp, priority: "Đang bán" },
    ],
  },
  {
  ...
  },
  {
    ...
    image: "/assets/product-aerator.png",
    products: [
      { name: "Tam hoa biến tần 1.5kW 220V", englishName: "DOLIC Tam Hoa Inverter Auto Feeder (1.5 kW, 220V)", model: "TY-1.5D", origin: "Trung Quốc - Yimin", specs: "1.5kW - 220V - ≥2.3 kg O2/h - 28kg - 3 chế độ 1.1/0.75/0.55kW - IPX8", price: "6.750.000", image: "/assets/product-aerator.png", status: "Đang bán", details: "Motor nam châm vĩnh cửu hiệu suất cao, khung inox 304, phao HDPE. Tuổi thọ động cơ ước tính 3-5 năm. Hiệu suất cao, tiết kiệm điện, bảo hành bảo dưỡng nhanh chóng.", usp: inverterUsp, priority: "Đang bán" },
      { name: "Tam hoa biến tần 2.2kW 380V", englishName: "DOLIC Tam Hoa Inverter Auto Feeder (2.2 kW, 380V)", model: "TY-2.2", origin: "Trung Quốc - Yimin", specs: "2.2kW - 380V - ≥4.0 kg O2/h - 30kg - 3 chế độ 1.6/1.3/0.75kW - IPX8", price: "7.750.000", image: "/assets/product-aerator.png", status: "Đang bán", details: "Motor nam châm vĩnh cửu hiệu suất cao, khung inox 304, phao HDPE. Tuổi thọ động cơ ước tính 3-5 năm. Hiệu suất cao, tiết kiệm điện, bảo hành bảo dưỡng nhanh chóng.", usp: inverterUsp, priority: "Đang bán" },
      { name: "Tam hoa cơ 0.75kW 220V", englishName: "DOLIC Tam Hoa Mechanical Auto Feeder (0.75 kW, 220V)", model: "YL-0.75", origin: "Trung Quốc - Yimin", specs: "0.75kW - 220V - ≥1.1 kg O2/h - 42kg - 148 vòng/phút - IPX8", price: "6.000.000", image: "/assets/products/tam-hoa-co-075kw-220v.jpg", status: "Đang bán", details: "Motor nam châm vĩnh cửu hiệu suất cao, khung inox 304, phao HDPE. Tuổi thọ động cơ ước tính 3-5 năm. Ưu điểm: hiệu suất cao, nhiệt độ làm việc thấp, lưu lượng nước lớn.", usp: inverterUsp, priority: "Đang bán" },
      { name: "Tam hoa cơ 1.5kW 380V", englishName: "DOLIC Tam Hoa Mechanical Auto Feeder (1.5 kW, 380V)", model: "YL-1.5", origin: "Trung Quốc - Yimin", specs: "1.5kW - 380V - ≥2.3 kg O2/h - 42kg - 138 vòng/phút - IPX8", price: "7.000.000", image: "/assets/product-aerator.png", status: "Đang bán", details: "Motor nam châm vĩnh cửu hiệu suất cao, khung inox 304, phao HDPE. Tuổi thọ động cơ ước tính 3-5 năm. Hiệu suất cao, tiết kiệm điện, bảo hành bảo dưỡng nhanh chóng.", usp: inverterUsp, priority: "Đang bán" },
    ],
  },
  {
    id: "combo-thiet-bi",
