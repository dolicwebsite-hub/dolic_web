...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Tam hoa cơ 0.75kW 220V", englishName: "DOLIC Tam Hoa Mechanical Auto Feeder (0.75 kW, 220V)", model: "YL-0.75", origin: "Trung Quốc - Yimin", specs: "0.75kW - 220V - ≥1.1 kg O2/h - 42kg - 148 vòng/phút - IPX8", price: "6.000.000", image: "/assets/products/drive-full/tam-hoa-co-075-cutout.webp", status: "Đang bán", details: "Motor nam châm vĩnh cửu hiệu suất cao, khung inox 304, phao HDPE. Tuổi thọ động cơ ước tính 3-5 năm. Ưu điểm: hiệu suất cao, nhiệt độ làm việc thấp, lưu lượng nước lớn.", usp: inverterUsp, priority: "Đang bán" },
